...
i1 = Item.create({ name: 'Tokyo Ramen', description: 'Stylish shades', price: 99.99, user_id: u1.id, category_id: c3.id })
i2 = Item.create({ name: 'Salmon Sashimi', description: 'Expensive timepiece', price: 199.99, user_id: u1.id, category_id: c1.id })
i3 = Item.create({ name: 'Hokkaido Tart', description: 'Classy knitwear', price: 299.99, user_id: u1.id, category_id: c4.id })
i4 = Item.create({ name: 'Coke', description: 'Cosy footwear', price: 399.99, user_id: u1.id, category_id: c2.id })